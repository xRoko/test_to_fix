import ContactsPages '../3-invoice_pages/contacts_pages';
import NewContactPages from ../3-invoice_pages/new_contact_pages;



class ContactsLibary

    addFirstContact(firma) {
...
modul.exports = new ContactsLibary();
